...
extract_data_from_tsv = BashOperator(
    ...
    bash_command='cut -d" " -f5,6,7 tollplaza-data.tsv | awk \'BEGIN {OFS=","} {print $1, $2, $3}\' > tsv_data.csv',
    dag=dag,
)
...
unzip_data >> extract_data_from_csv, extract_data_from_fixed_width, extract_data_from_tsv >> consolidate_data 
